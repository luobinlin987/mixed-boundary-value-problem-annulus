...
Subroutine calc
  ...
  write(*,*) 'Total iteration reps of Case D =', q
  ! do k=1,2*N+1
  !    write(*,*) d(k)
  ! enddo
  open(2001,file=datapath//'/dk/case_d_solution1.csv')
  do k=-N,N
...
20001 format(I4,A,F10.6,A,F10.6)
  ...
  open(1001,file=datapath//'/case_d/stress_case_d.csv')
  do i=1,T+1
  ...
  open(1002,file=datapath//'/case_d/displacement_case_d.csv')
  do i=1,T+1
  ...
  ! enddo
  write(*,*) 'Horizontal rigid-body displacement of Case D Sol 1 =', ux(T)*1e1
  write(*,*) 'Vertical rigid-body displacement of Case D Sol 1 =', uy(T)*1e1
