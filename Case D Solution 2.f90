...
Subroutine calc
  ...
  enddo
  open(1010,file=datapath//'/ck12/ck12_case_d.csv')
  do l=1,N
     write(1010,20002) l, ',' &
...
20002 format(I4,A,F10.6,A,F10.6,A,F10.6,A,F10.6)
  ...
  write(*,*) 'Maximum error between ck12 and beta =', maxval(err_ck11_beta)-minval(err_ck11_beta)
  deallocate(tht,eta1)
  ...
  enddo
  write(*,*) 'Error of', q, 'th iteration =',err
  open(2001,file=datapath//'/dk/case_d_solution2.csv')
  do k=-N,N
...
20001 format(I4,A,F10.6,A,F10.6)
  ...
  open(1001,file=datapath//'/case_d/stress_case_d2.csv')
  do i=1,T+1
  ...
  open(1002,file=datapath//'/case_d/displacement_case_d2.csv')
  do i=1,T+1
  ...
  ! enddo
  write(*,*) 'Horizontal rigid-body displacement of Case D Sol 2 =', ux(T)*1e1
  write(*,*) 'Vertical rigid-body displacement of Case D Sol 2 =', uy(T)*1e1
